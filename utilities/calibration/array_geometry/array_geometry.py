...
# ===============================================================
# Vector from array center to camera (mm). "Camera → Array Center" was (49.66, 30.68, 7.40), so center→camera = negated.
ARRAY_CENTER_TO_CAMERA_MM = (49.66, 30.68, 7.40)
ARRAY_CENTER_TO_CAMERA_DIST_MM = 58.84

# Mics: (label, min_dist_mm, x_mm, y_mm, z_mm); x,y,z = from camera to mic (source of truth for measurements)
MICS_RAW = [
    ("U1", 53.22, 47.76, 22.30, 7.40),
    ("U2", 37.69, 25.86, 26.40, 7.40),
    ("U3", 43.97, 36.36, 23.60, 7.40),
    ("U4", 42.64, 39.96, 12.90, 7.40),
    ("U6", 68.26, 61.26, 29.20, 7.40),
    ("U7", 52.80, 51.86, 6.60, 7.40),
    ("U8", 59.23, 56.46, 16.30, 7.40),
    ("U9", 71.28, 67.96, 20.20, 7.40),
    ("U11", 49.52, 31.36, 37.60, 7.40),
    ("U12", 81.10, 62.46, 51.20, 7.40),
    ("U13", 70.77, 52.66, 46.70, 7.40),
    ("U14", 67.20, 42.16, 51.80, 7.40),
    ("U16", 58.50, 41.76, 40.30, 7.40),
    ("U17", 58.30, 48.56, 31.40, 7.40),   # center most
    ("U18", 77.31, 66.46, 38.80, 7.40),
    ("U19", 64.68, 53.36, 35.80, 7.40),
]
